...
function MainRouter() {
  const [page, setPage] = useState<'main' | 'simple'>('main');

  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      <nav style={{ width: 220, background: '#f5f5f5', padding: '2em 1em', borderRight: '1px solid #ddd' }}>
        <h2 style={{ fontSize: '1.2em', marginBottom: '1.5em' }}>Pages</h2>
        <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
          <li>
            <button
              style={{ width: '100%', padding: '0.7em', marginBottom: '0.5em', background: page === 'main' ? '#1976d2' : '#fff', color: page === 'main' ? '#fff' : '#222', border: 'none', borderRadius: 6, cursor: 'pointer', fontWeight: 600 }}
